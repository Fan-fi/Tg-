from logic_вау import DB_Manager
from logic_вау import *
from config import *
...
/skills - позволяет добавить скилы к проекту
/projects - все о проекте
/delete - удалить проект
/update_projects - дополнить проект
...
def callback_project(message, data, statuses):
    ...
    # ИСПРАВЛЕННАЯ СТРОКА - передаем кортеж напрямую, а не список
